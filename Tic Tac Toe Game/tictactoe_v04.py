...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  2 14:50:47 2021
...
Problems about this code:
    ...
    1) SOLVED
    2) SOLVED
    3) The game does not recognize if the number of possible moves has been made and stops the game (9 in this case)
    4) New Problem: The code should not allow for re-writing on existing spaces on the board
