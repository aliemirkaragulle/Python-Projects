...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  2 13:49:30 2021
...
def game_on_or_off():
    ...
    """
    This function returns a boolean which determines if the game has ended or not.
    The game can end in two conditions:
        1) If the game has won by a player
        2) The result of the game is indecisive and the game has ended because the maximum round number has been reached.
          (The maximum round number is 9 since there are only 9 spaces in the game and we can not overwrite already written spaces)
    """    
    ...
    while game_on:        
        ...
        if(game_board[0][0] == "X" and game_board[0][1] == "X" and game_board[0][2] == "X" or
                game_board[0][0] == "O" and game_board[0][1] == "O" and game_board[0][2] == "O"):          
            return False
            
        elif(game_board[1][0] == "X" and game_board[1][1] == "X" and game_board[1][2] == "X" or
                game_board[1][0] == "O" and game_board[1][1] == "O" and game_board[1][2] == "O"):          
            return False
            
        elif(game_board[2][0] == "X" and game_board[2][1] == "X" and game_board[2][2] == "X" or
                game_board[2][0] == "O" and game_board[2][1] == "O" and game_board[2][2] == "O"):          
            return False
            
        elif(game_board[0][0] == "X" and game_board[1][0] == "X" and game_board[2][0] == "X" or
                game_board[0][0] == "O" and game_board[1][0] == "O" and game_board[2][0] == "O"):          
            return False
                
        elif(game_board[0][1] == "X" and game_board[1][1] == "X" and game_board[2][1] == "X" or
                game_board[0][1] == "O" and game_board[1][1] == "O" and game_board[2][1] == "O"):          
            return False
            
        elif(game_board[0][2] == "X" and game_board[1][2] == "X" and game_board[2][2] == "X" or
                game_board[0][2] == "O" and game_board[1][2] == "O" and game_board[2][2] == "O"):          
            return False
            
        elif(game_board[0][0] == "X" and game_board[1][1] == "X" and game_board[2][2] == "X" or
                game_board[0][0] == "O" and game_board[1][1] == "O" and game_board[2][2] == "O"):          
            return False
            
        elif(game_board[0][2] == "X" and game_board[1][1] == "X" and game_board[2][0] == "X" or
...
Problems about this code:
    ...
    2) The game does not have a condition to end
       - Now it ONLY ENDS FOR THE PLAYER 2 (WITH THE LABEL 'O')
       - Also it does not count the number of the rounds played
       - I think I should seperate the game_on_or_off() function for each player
"""
